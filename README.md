# MLKV: Scaling up Large Embedding Model Training with Key-Value Storage
...
* [MLKV-PYTHON](https://github.com/ml-kv/mlkv-gnn/blob/dgl-v2.3.0-mlkv/python/dgl/storages/mlkv.py): python wrapper
